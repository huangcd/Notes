...
namespace DrawToNote
{
    ...
    //                 frame = new Frame();
    //                 DrawToNote.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
    //
    ...
    //                      try
    //                     {
    //                         await DrawToNote.Common.SuspensionManager.RestoreAsync();
    //                     }
    //                     catch (DrawToNote.Common.SuspensionManagerException)
    //                     {
    ...
    public sealed partial class ScriptSearchResultPage : LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            filterList.Add(new Filter("Me", 1, true));
